...
export const INITIAL_DATA: ResumeData = {
  ...
  skills: [
    ...
    { zh: "英语六级 (CET-6)", en: "English CET-6" },
    { zh: "日语四级 (JLPT N4)", en: "Japanese JLPT N4" }
  ],
  education: [
    {
      id: "edu-1",
      ...
      responsibilities: [
        {
          ...
          en: "Led the NPI for Hithium US Recharge, Module, PACK, and Energy Storage Container lines. Based in the US to drive equipment qualification, pilot runs, and production ramp-up."
        },
        {
          zh: "对接美国团队，完成项目从中国设备开发团队移交至美国运维团队；参加新产品设计变更评审，组织中美团队推进项目改造计划。",
          en: "Managed project handover from China R&D to US Operations teams; participated in Engineering Change Order (ECO) reviews and organized cross-functional teams for equipment retrofits."
        },
        {
          zh: "通过飞书云文档开发设备故障统计系统，可以追溯设备DT时间、运维人员响应时间等信息。",
          en: "Developed a digital equipment downtime tracking system via Lark/Feishu to monitor Downtime (DT) metrics and maintenance response efficiency."
        }
      ]
    },
    {
  ...
  projects: [
    {
      id: "proj-hithium-1",
      company: { zh: "美国海辰补电、模组、PACK、集装箱线导入", en: "US Hithium Recharge, Module, PACK & Container Line NPI" },
      position: { zh: "海辰项目经历", en: "Hithium Project Experience" },
      period: "2025.07 - Present",
      responsibilities: [
        { zh: "(1) 负责美国海辰补电、模组、PACK、集装箱线导入相关工作；Base美国辅助完成各产线设备导入、qualify、试生产及爬坡阶段任务。", en: "(1) Led NPI for Recharge, Module, PACK, and Container lines; Based in the US to drive equipment qualification, pilot runs, and production ramp-up." },
        { zh: "(2) 对接美国团队，完成项目从中国设备开发团队移交至美国运维团队；参加新产品设计变更评审，组织中美团队推进项目改造计划。", en: "(2) Managed project handover from China R&D to US Operations; participated in ECO reviews and organized cross-border teams for equipment retrofits." },
        { zh: "(3) 通过飞书云文档开发设备故障统计系统，可以追溯设备DT时间、运维人员响应时间等信息。", en: "(3) Developed a digital equipment downtime tracking system to monitor DT metrics and maintenance response efficiency." }
      ]
    },
    {
      id: "proj-csi-1",
